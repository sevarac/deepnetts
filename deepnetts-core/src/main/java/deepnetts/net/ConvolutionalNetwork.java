...
public class ConvolutionalNetwork extends NeuralNetwork implements Serializable {
    ...
    public static class Builder {
         ...
         * @return 
         */
        public Builder inputLayer(int width, int height) {
        ...
        /**
         * Adds output layer with specified width and soft max activation function
         * 
        ...
        public Builder convolutionalLayer(int filterSize, int channels) { 
        ...
        public Builder maxPoolingLayer(int filterSize, int stride) {
    ...
    /**
     * Returns all weights from this network.
     * 
     * @return 
     */
    public List<String> getWeights() {
        ...
        for(AbstractLayer layer : getLayers()) {
            weightsList.add(layer.getWeights().toString());
        }
        return weightsList;
    }
